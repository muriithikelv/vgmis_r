                            ...
                            <div class="row" style="margin-bottom: 20px">
                                   <div class="col-md-3">Mobile Number: <span
                                    ...
                                    <div class="col-md-3">Role: <span
                                        style="font-weight:bold">{{ $user->role->role_name}}</span></div>
                                 </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                {{ Form::model(@$editModeData, array('route' => array('user.update', $editModeData->user_id), 'method' => 'PUT','files' => 'true','id' => 'kt_modal_add_user_form')) }}
