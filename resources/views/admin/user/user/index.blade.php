												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
															...
															<!--begin::Form-->
															@if(isset($editModeData))
                                                            {{ Form::model($editModeData, array('route' => array('user.update', $editModeData->user_id), 'method' => 'PUT','files' => 'true', 'class'=>'form', 'id' => 'kt_modal_add_user_form')) }}
                                                            @else
                                                            {{ Form::open(array('route' => 'user.store', 'class'=>'form', 'enctype'=>'multipart/form-data','id'=>'kt_modal_add_user_form')) }}
                                                            @endif
																<!--begin::Scroll-->
																	...
																	<div class="fv-row mb-7">
																		...
																		{{-- <input type="text" name="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="Emma Smith" />
																		 --}} {!! Form::text('first_name', Input::old('first_name'), $attributes =
                                                                                ...
                                                                                first_name','name'=>'first_name','id'=>'first_name','placeholder'=>'Enter your first name')) !!}
                                                                        <!--end::Input-->
																	</div>
                                                                    <div class="fv-row mb-7">
																		<!--begin::Label-->
