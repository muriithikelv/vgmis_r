                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            @if (isset($editModeData))
                            {{ Form::model($editModeData, ['route' => ['harvest.update', $editModeData->harvest_id], 'method' => 'PUT', 'files' => 'true', 'id'=>'kt_modal_add_user_form', 'class' => 'form']) }}
                        @else
                            {{ Form::open(['route' => 'harvest.store', 'enctype' => 'multipart/form-data', 'class' => 'form', 'id'=>'kt_modal_add_user_form']) }}
                        @endif
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Quantity (in kgs)</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                            {!! Form::text(
                                                'amount',
