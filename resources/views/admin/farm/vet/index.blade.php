                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                        @if(isset($editModeData))
						{{ Form::model($editModeData, array('route' => array('vet.update', $editModeData->county_id), 'method' => 'PUT','files' => 'true','id'=>'kt_modal_add_user_form','class' => 'form')) }}
						@else
						{{ Form::open(array('route' => 'vet.store','enctype'=>'multipart/form-data','id'=>'kt_modal_add_user_form','class'=>'form')) }}
						@endif
                                <!--begin::Scroll-->
