                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            @if (isset($editModeData))
                            {{ Form::model($editModeData, ['route' => ['livestock.update', $editModeData->livestock_id], 'method' => 'PUT', 'files' => 'true', 'id'=>'kt_modal_add_user_form', 'class' => 'form']) }}
                        @else
                            {{ Form::open(['route' => 'livestock.store', 'enctype' => 'multipart/form-data', 'class' => 'form', 'id'=>'kt_modal_add_user_form']) }}
                        @endif
                                <!--begin::Scroll-->
