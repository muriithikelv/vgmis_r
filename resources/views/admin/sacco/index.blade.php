									 ...
									 <!--end::Alert-->
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search group" />
											</div>
											<!--end::Search-->
										</div>
										<!--begin::Card title-->
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a type="button" class="btn btn-light-primary me-3" href="{{url("export")}}">
												...
												<!--end::Add user-->
												<!--begin::Add in bulk-->
												<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bulk-upload">
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Plus.svg-->
													<span class="svg-icon svg-icon-2">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<rect fill="#000000" x="4" y="11" width="16" height="2" rx="1" />
											...
											<!--end::Modal - New Card-->
											<!--begin::Modal - Add bulk-->
    <div class="modal fade" id="bulk-upload" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    {{ Form::open(array('route' => 'sacco.import', 'enctype'=>'multipart/form-data','class'=>'form')) }}

                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                         <!--begin::Input group-->
													<div class="fv-row mb-8">
														<label class="fs-6 fw-bold mb-2">Excel File</label>
														<!--begin::Dropzone-->
													...
													<!--end::Input group-->
													 <!--begin::Input group-->
													 <div class="fv-row mb-8">
														<label class="fs-6 fw-bold mb-2">Download County list with their respective ids</label>
														<!--begin::Button-->
														<a href="{{ URL('list/?county')}}" class="btn btn-white me-3">Download</a>
														<!--end::Button-->
													</div>
													<!--end::Input group-->
                        </div>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a href="{!!  route('sacco.show', $value->sacco_id) !!}" class="text-gray-800 text-hover-primary mb-1">{!! $value->sacco_name!!}</a>
