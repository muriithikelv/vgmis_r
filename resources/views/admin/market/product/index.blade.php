                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
						@if(isset($editModeData))
						{{ Form::model($editModeData, array('route' => array('product.update', $editModeData->product_id), 'method' => 'PUT','files' => 'true','class' => 'form', 'id'=>'kt_modal_add_user_form')) }}
						@else
						{{ Form::open(array('route' => 'product.store','enctype'=>'multipart/form-data','class'=>'form','id'=>'kt_modal_add_user_form')) }}
						@endif
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
											{{ Form::select('user_id',$data, Input::old('user_id'), array('class' => 'form-control form-control-solid mb-3 mb-lg-0 user_id select2', 'required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    ...
                                    {{ Form::select('vendor_id',$vendors, Input::old('vendor_id'), array('class' => 'form-select form-select-solid fw-bolder vendor_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    </div>

                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Category</label>
                                    {{ Form::select('category_id',$categorys, Input::old('category_id'), array('class' => 'form-select form-select-solid fw-bolder category_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    </div>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button type="submit" class="btn btn-primary" data-kt-users-modal-action="">
                                        <span class="indicator-label">Submit</span>
                                        <span class="indicator-progress">Please wait...
                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    </button>
